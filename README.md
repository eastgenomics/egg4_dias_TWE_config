...
| Type | Name | dias_TWE_config_GRCh37_v3.3.1.json | dias_TWE_config_GRCh38_v4.7.1.json |
| -- | -- | -- | -- |
...
| File | **twe_vep_config for SNV reports** | twe_vep_config_v1.2.1.json (`file-J051vX04j4fjv5YvY53JJK3V`) | twe_vep_config_GRCh38_v1.1.6.json(`file-J428JZ04j4fY0JYY3gQYpQjY`) |
